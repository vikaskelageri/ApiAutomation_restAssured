...
public class OllamaDataGenerator {
    ...
    public static String getPayloadFromOllama() {
        try {
            ...
            // Prompt for structured JSON using a descriptive text, escaping newlines
            String prompt = "Generate a realistic JSON object with the following fields:\\n" +
                    "- company_name (string)\\n" +
                    "- email (string)\\n" +
                    "- first_name (string)\\n" +
                    "- is_physical_mailing_same (boolean)\\n" +
                    "- last_name (string)\\n" +
                    "- mailing_address (object with: address (string), state (string), city (string), postal_code (string))\\n" +
                    "- new_comm (integer)\\n" +
                    "- phone (string)\\n" +
                    "- physical_address (object with: address (string), state (string), city (string), postal_code (string))\\n" +
